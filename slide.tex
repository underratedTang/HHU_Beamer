...
\begin{frame}{系统初始化}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth]{/Users/tanglixinran/Downloads/河海大学/11.2周六课汇报/fig/Fig_2.png} % 替换为图2的具体文件名
        \caption{系统初始化过程}
        \label{Fig_2}
    \end{figure}
\end{frame}
...
\begin{frame}{用户注册过程 (2/2)}
    \begin{itemize}
        \item 第三步：用户从CA收到回复后，获取随机私钥 \textit{G1} 和用户的临时身份 \textit{UTID}。用户使用 \textit{G1}、\textit{UTID} 和 \textit{RUPW} 计算 \textit{D}，并将以下信息存储在内存中：%\textit{G1}、\textit{UTID}、\textit{N} 和 \textit{D}
    \end{itemize}

    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{/Users/tanglixinran/Downloads/河海大学/11.2周六课汇报/fig/Fig_3.png} % 替换为图3的具体文件名
        \caption{用户注册过程}
    \end{figure}
\end{frame}
...
\begin{frame}{设备注册过程 (2/2)}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{/Users/tanglixinran/Downloads/河海大学/11.2周六课汇报/fig/Fig_4.png} % 替换为图4的具体文件名
        \caption{设备注册过程}
    \end{figure}
\end{frame}
...
\begin{frame}{登录与认证过程 (3/3)}
    \begin{figure}
        \centering
        \includegraphics[width=0.4\textwidth]{/Users/tanglixinran/Downloads/河海大学/11.2周六课汇报/fig/Fig_5.png} % 替换为图5的具体文件名
        \caption{登录与认证过程}
    \end{figure}
\end{frame}
